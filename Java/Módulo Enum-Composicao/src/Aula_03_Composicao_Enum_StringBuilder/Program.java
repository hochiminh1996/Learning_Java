...
public class Program {
	public static void main(String[] args) throws ParseException {
		...
		// criando um pedido e o stutus do enum. Observe que estamos passando um objeto cliente.
		...
		for (int i = 1; i <= n; i++) {
			...
			OrderItem or_item = new OrderItem(price, quant, product);
			// Instanciado um item do pedido que está associado, via composição, com um produto
