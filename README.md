...
* Polimorfismo de Sobrecarga: Permite que um mesmo método, com assinaturas diferentes (tipo e número de parâmetros), seja implementado na mesma classe. Por exemplo, temos uma classe chamada "Calculadora" que possui o método "calcular". Nesse exemplo, podemos ter, na mesma classe, 3 tipos de métodos "calcular" com parâmetros e tipos diferentes. Um método "calcular" que recebe apenas inteiro, o outro apenas reais, o outro reais e inteiros e etc. Esse é um exemplo de Polimorfismo de Sobrecarga.  
