...
* <strong>Associação:</strong> Na associação, os objetos envolvidos podem se comunicar e interagir, mas não precisam ser parte um do outro. Por exemplo, um “cliente” pode ter vários “pedidos” e um “pedido” pode ser feito por um único “cliente”, mas ambos podem existir independentemente um do outro.
